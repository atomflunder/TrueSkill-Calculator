...
<ul>
	<li>Add or remove Teams and assign each the correct number of players present in your game.</li>
	<li>
	...
	<li>
		...
		whole match, and values below 1 mean the Player has left the game early. A Weight of 0 means the
